...
var blueColorMsg = Blockly.Msg.GBS_COLOR_BLUE_MSG;
console.log(blueColorMsg);
Blockly.Blocks.ColorSelector =
  createLiteralSelectorBlock(
    'Color', [
      ['GBS_COLOR_BLUE_MSG', 'Azul'],
      ['GBS_COLOR_BLACK_MSG', 'Azul'],
      ['GBS_COLOR_RED_MSG', 'Azul'],
      ['GBS_COLOR_GREEN_MSG', 'Azul']
    ]);
...
Blockly.Blocks.AlternativaEnExpresiones = {
  ...
  _addElement: function() {
    ...
    this.appendDummyInput().appendField('%{BKY_GBS_CHOOSE_MSG_1}').name = "label1" + this.length;
    const input1 = this.appendValueInput('element' + this.length);
    this.appendDummyInput().appendField('%{BKY_GBS_CHOOSE_MSG_2}').name = "label2" + this.length;
  ...
  _removeElement: function(n) {
    const elements = ["label1", "%{BKY_GBS_CHOOSE_MSG_1}", "label2", "%{BKY_GBS_CHOOSE_MSG_2}", "newline"];
  ...
  _addOtherwise: function() {
    ...
    textInput.appendField("%{BKY_GBS_TOOLTIPS_OPTIONS_OR_ELSE}");
